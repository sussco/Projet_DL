...
a.gradient_descent([1], 3)
a.propagation()
print 'valeur des neuronnes apres avoir passe plusieurs fois l entree [1,1]:\n', a.layer, '\n'

a.init([1,0])
a.propagation()
a.gradient_descent([0], 3)
a.propagation()
a.gradient_descent([0], 3)
a.propagation()
a.gradient_descent([0], 3)
...
a.gradient_descent([0], 3)
a.propagation()
print 'valeur des neuronnes apres avoir passe plusieurs fois l entree [1,0]:\n', a.layer, '\n'
...
a.gradient_descent([0], 3)
a.propagation()
print 'valeur des neuronnes apres avoir passe plusieurs fois l entree [0,0]:\n', a.layer, '\n'
...
a.gradient_descent([0], 3)
a.propagation()
print 'valeur des neuronnes apres avoir passe plusieurs fois l entree [0,1]:\n', a.layer, '\n'

a.init([0,1])
a.propagation()
print a.quadratic_error([0])

a.init([1,1])
a.propagation()
print a.quadratic_error([1])
