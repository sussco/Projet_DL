#Pour cet exemple, on regarde un réseau de neuronnes utilisant la librairie CIFAR
...
#on télécharge les composants
trainset = torchvision.datasets.CIFAR10(root='data', train=True, download=True, transform=transform)

#on charge les images pour l'entrainement. On peut modifier le facteur "batch_size"
#num workers = nombre de processus utilisés pour entrainer le tout
trainloader = torch.utils.data.DataLoader(trainset, batch_size=4, shuffle=True, num_workers=3)

#notre set de test
testset = torchvision.datasets.CIFAR10(root='data', train=False, download=True, transform=transform)

#on charge notre set de test
